...
public:
	...
	void				SetShot(portalShot_t *s);
	portalShot_t *		GetShot()					{ return pShot; }
	const portalShot_t	*GetShot() const			{ return pShot; }
...
inline void AI_Waypoint_t::SetShot(portalShot_t *s)
{
	pShot = s;
}
