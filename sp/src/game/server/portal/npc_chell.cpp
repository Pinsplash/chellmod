//on the last episode of programming...
//we discovered the magic of trying to include a CUtlVector in a struct, then turned subZoneLink_t into a class cause it might have helped.
//GetSZLink() should now work, the project built successfully, but the actual test will come next time
//All files that were including npc_chell.h now are not, cause they would have an LNK2005 error. I don't get that!!!!
...
//Add Flag: var |= flag
//Remove Flag: var &= ~flag
//Has flag: var & flag

//bind "/" "ent_create npc_chell"
//00: bind "'" "ent_fire npc_chell gotoentity elevator_body_model"
//01: bind "'" "ent_fire npc_chell gotoentity a00-a01_elevator_body_model"
//02: bind "'" "ent_fire npc_chell gotoentity a01-middleelevator_body_model"
//03: bind "'" "ent_fire npc_chell gotoentity a01-a02_elevator_body_model"

//CURRENT BUGS:
//0A: Chell rarely wants to double back when crossing through portals.
//0I: Chell looks up when waiting for the test 02 hypoportal. This is probably just because the waypoint is in the air. I'm not sure if i want to fix this, it's really not so bad.
